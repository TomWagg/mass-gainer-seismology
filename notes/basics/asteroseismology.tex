...
\textbf{Degrees and order:} The degree is $l$, the azimuthal order is $m$ and the radial order is $n$.

\textbf{Period spacing:} The periods of low-order high-degree $g$ modes ($N^2 \gg \omega^2$) are given by
\begin{equation}
    P_k = \frac{\pi^2}{\sqrt{l(l+1)} \int_{x_0}^{1} \frac{\abs{N}}{x} \dd{x}} (2 k + n_e)
\end{equation}
