...
! ***********************************************************************
  ...
  !          b% s1% job% warn_run_star_extras = .false.
        ...
        integer function extras_binary_finish_step(binary_id)
           ...
           ! if we want to detach the binary artificially
           if (b% s_accretor% x_logical_ctrl(1)) then
              ! detach binary once the accretor reaches a certain mass
              if (b% s_accretor% star_mass > b% s_accretor% x_ctrl(1)) then
