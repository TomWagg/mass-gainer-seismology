...
In Figure~\ref{fig:chi2_xc_0.2}, we show an example of this $\chi^2$ fitting. In this plot the mass-gainer model has a mass of $3.5 \msun$ and central hydrogen content of $X_c = 0.2$. However, the best fitting model when assuming single star evolution underestimates the mass at $3.1 \msun$ and significantly overestimates the central hydrogen content at $X_c = 0.4$, twice the true value. This best-fitting value is found along the trough of degeneracy between mass and hydrogen content.
